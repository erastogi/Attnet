...
def train_discriminator(discriminator, dis_opt, d_steps, epochs , num_batches):
    """
    ...
    for d_step in range(d_steps):
        ...
        for epoch in range(epochs):
            ...
            for i in range(0, num_batches) :   #2 * POS_NEG_SAMPLES, BATCH_SIZE):
...
if __name__ == '__main__':
    ...
    train_discriminator(dis, dis_optimizer, gen, 50, 3 , num_batches)
    ...
    for epoch in range(ADV_TRAIN_EPOCHS):
        ...
        sys.stdout.flush()
        train_generator_PG(gen, gen_optimizer,dis,num_batches)

        # TRAIN DISCRIMINATOR
        print('\nAdversarial Training Discriminator : ')
        train_discriminator(dis, dis_optimizer,gen, oracle, 5, 3 ,num_batches)